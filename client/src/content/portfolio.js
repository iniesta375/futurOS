/**
 * portfolio.js — FuturOS Master Content Configuration
 * ─────────────────────────────────────────────────────
 *
 * THIS IS THE ONLY FILE YOU NEED TO EDIT.
 *
 * Every name, email, job title, GitHub URL, project description, and metric
 * in the portfolio pulls from this file. No component hunting required.
 *
 * ┌─────────────────────────────────────────────────────────────────────┐
 * │  SETUP CHECKLIST                                                    │
 * │  ─────────────                                                      │
 * │  □  1. Fill in IDENTITY (name, title, email, location)             │
 * │  □  2. Fill in SOCIALS (GitHub, LinkedIn, Twitter URLs)            │
 * │  □  3. Add your RESUME_URL (Dropbox/Drive/direct link)             │
 * │  □  4. Fill in EXPERIENCE (real companies, real bullets)           │
 * │  □  5. Fill in PROJECTS (real repos, real metrics or remove them)  │
 * │  □  6. Update index.html with your name + Twitter handle           │
 * │  □  7. Update public/sitemap.xml with your real domain             │
 * │  □  8. Drop your real resume.pdf in public/resume.pdf              │
 * └─────────────────────────────────────────────────────────────────────┘
 *
 * CONTENT POLICY (read before shipping):
 *
 *   Fake metrics are worse than no metrics.
 *   If a project stat is unverifiable (e.g. "50k events/sec" with no link),
 *   remove it. Use `verifiable: false` to mark stats you want to keep but
 *   which aren't publicly confirmable — the UI will render them without
 *   a link badge.
 *
 *   Demo project entries are fine to keep for the OS itself (FuturOS)
 *   since the recruiter is literally looking at it. But every other project
 *   should have a real GitHub URL or be marked `status: 'private'`.
 */
